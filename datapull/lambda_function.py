...
# key is to get folder structure..
def _get_key():
...
#getting the data from API and loading the data into Python Dict..
...
# Writing the data to local folder
...
#downloading the data from API and writing the data into local filesystem..
def download_data(N):
